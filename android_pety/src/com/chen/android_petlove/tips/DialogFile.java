...
public class DialogFile extends AlertDialog {
	...
	public DialogFile(Context context,CharSequence title,CharSequence type,CharSequence weight,CharSequence character,CharSequence age,CharSequence sex,CharSequence note) {
		super(context);
